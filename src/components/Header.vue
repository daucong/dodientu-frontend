      ...
      <div class="col-lg-4 col-md-12 col-12 ms-auto">
        <div class="row mx-auto justify-content-end">
          ...
          <div class="col-lg-3 col-md-2 col-sm-3 col-3 align-self-center px-0">
            <v-btn class="span-login float-end px-0" variant="text" v-if="!this.loggedIn" @click="$router.push('login')">
            ...
            <v-btn class="span-login px-0 float-end" v-if="this.loggedIn" variant="text">
              ...
              <v-menu open-on-hover
                ...
                <v-list>
                  ...
                  <v-list-item>
                    <v-btn variant="text" prepend-icon="mdi:mdi-table-edit"  @click="$router.push({name: 'user-list-post'}) ">
                      {{ $t('header.managePost') }}
                    </v-btn>
                  </v-list-item>
                  ...
                  <v-list-item
                  >
                    <v-btn variant="text" prepend-icon="mdi:mdi-account-outline" @click="goToInfoAccount">
                      {{ $t('header.changeInfo') }}
                    </v-btn>
                  </v-list-item>
                  <v-list-item v-if="showChangePass">
                    <v-btn variant="text" prepend-icon="mdi:mdi-account-key" @click="gotoChangePass">
                      {{ $t('changePass') }}
                    </v-btn>
                  </v-list-item>
                  <v-list-item>
                    <v-btn variant="text" prepend-icon="fa fa-light fa-money-bills" @click="gotoRecharge">
                      {{ $t('header.recharge') }}
                    </v-btn>
                  </v-list-item>
                  <v-divider></v-divider>
